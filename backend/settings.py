...
SECRET_KEY = "django-insecure-&y8+msc7v&zy2s6h6dr(&osybev2emf)c4#lwb!bz$lfggu&6t"
...
STATIC_URL = "/static/"
STATICFILES_DIRS = [BASE_DIR / 'static']  # Add the static folder for CSS, JS, and images
